        ...
        <div className="page container">
            <div id="food_options_lgscrn" className="row">
                <div className="col-md-4 py-2 d-flex flex-column flex-wrap">
                    ...
                    <a className="btn btn-animation border-orange mt-3 menu_writing current" href="/wings" role="button">Wings</a>
                </div>
                    ...
                    {wingsMenu.map((item, i) => {
                        ...
                        return (
                            <div className="card col-lg-5 col-md-6 border-0 food_cards m-2">
                                <img className="card-img-top m-auto rounded border-orange" src={item.wingsImgPath} style={{ height: '190px', width: '235px' }} alt="" />
