                ...
                <div className="container mt-5">
                    <div className="d-flex row text-center">
                        <div className="card col-lg-4 col-sm-6 bg_xtrablk border-0 food_cards">
                            <img className="card-img-top m-auto border rounded border_nude" src={Sweets} style={{ height: '175px', width: '235px' }} alt="" />
                ...
                <div className="container col mt-2 mr-4">
                    <div className="d-flex row flex-wrap justify-content-around text-center">
                        <div className="card bg_xtrablk col-lg-5 col-md-6 border-0 food_cards m-2">
                            <img className="card-img-top m-auto border rounded border_nude" src={Sweets} style={{ height: '175px', width: '200px' }} alt="" />
                            <div className="card-body">
                                <div className="card-title font-weight-bold menu_writing">Mango Overload</div>
                            </div>
                        </div>
